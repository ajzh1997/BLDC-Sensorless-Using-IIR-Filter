...
volatile unsigned int RampStartDemand = 30;		// % demand at the beginning of the open-loop starting ramp
volatile unsigned int RampEndDemand = 50;		// % demand at the end of the open-loop starting ramp
volatile unsigned int RampDuration = 40000;		// Ramp duration in 1ms increments
...
volatile unsigned int PhaseAdvanceStart = 700;	// The RPM at which point phase advance begins to be added
