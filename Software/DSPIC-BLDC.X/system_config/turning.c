...
volatile unsigned int RampStartDemand = 40;		// % demand at the beginning of the open-loop starting ramp
volatile unsigned int RampEndDemand = 60;		// % demand at the end of the open-loop starting ramp
volatile unsigned int RampDuration = 700;		// Ramp duration in 1ms increments
volatile unsigned int RampStartSpeed = 100;		// Speed (in RPM) at the beginning of the open-loop starting ramp
volatile unsigned int RampEndSpeed = 1100;		// Speed (in RPM) at the end of the open-loop starting ramp
...
volatile unsigned int InitialDemand = 60;		// % demand immediately after the starting ramp is completed.
volatile unsigned int NoOfMotorPoles = 12;		// Number of motor poles (not pole-pairs)
volatile unsigned int CrossOverERPS = 50; 		// low speed to high speed (and vice versa) crossover speed in electrical revs per second
